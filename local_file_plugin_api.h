...
struct sppb_byte_input {
	/// An identifier for the input stream. This is informational only.
	/// May be NULL.
	/// You are not allowed to modify the contents.
	char *uri;

	/// Close the input and free all resources used (including itself.)
